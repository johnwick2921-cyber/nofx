...
- 🔧 **P3.6** `0a292148` CORE done: activation window (1.5×dATR filter), death→re-plan (cap→NO-TRADE), RESTART RECOVERY (mandatory fixture ✓). REMAINING: digest writers (session/daily/week), scenario re-arm via level-state, sticky owner levels, night mode
