...
func TestWeeklyShadowZeroRealEffect(t *testing.T) {
	...
	first, _, _ := AssembleScoredLevelsMinGrade("", bars, reg, "MNQ", 8, LegacyHtfSeats, now, 1.5, "")
	...
	second, _, _ := AssembleScoredLevelsMinGrade("", bars, reg, "MNQ", 8, LegacyHtfSeats, now, 1.5, "")
