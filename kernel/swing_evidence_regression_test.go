...
func TestSwingAggregationConservesFirstBarVolume(t *testing.T) {
	...
	bars := []market.Kline{{OpenTime: start, Open: 100, High: 102, Low: 99, Close: 101, Volume: 10}, {OpenTime: start + 60000, Open: 101, High: 103, Low: 100, Close: 102, Volume: 7}, {OpenTime: start + 300000, Open: 102, High: 104, Low: 101, Close: 103, Volume: 11}}
