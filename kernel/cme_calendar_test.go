...
func TestIsCMEOpen(t *testing.T) {
	...
	cases := []struct {
		...
		{"MLK Day 2026 (Jan 19) — SHORTENED, before close", time.Date(2026, 1, 19, 10, 0, 0, 0, chicago), true},
		{"MLK Day 2026 — after its 12:00 CT close", time.Date(2026, 1, 19, 12, 30, 0, 0, chicago), false},
		{"Presidents Day 2026 (Feb 16) — SHORTENED, before close", time.Date(2026, 2, 16, 10, 0, 0, 0, chicago), true},
		{"Presidents Day 2026 — after its 12:00 CT close", time.Date(2026, 2, 16, 12, 30, 0, 0, chicago), false},
		{"Good Friday 2026 (Apr 3)", time.Date(2026, 4, 3, 10, 0, 0, 0, chicago), false},
		{"Memorial Day 2026 (May 25) — SHORTENED, before close", time.Date(2026, 5, 25, 10, 0, 0, 0, chicago), true},
		{"Memorial Day 2026 — after its 12:00 CT close", time.Date(2026, 5, 25, 12, 30, 0, 0, chicago), false},
		{"Juneteenth 2026 — SHORTENED, before close", time.Date(2026, 6, 19, 10, 0, 0, 0, chicago), true},
		{"Juneteenth 2026 — after its 12:00 CT close", time.Date(2026, 6, 19, 12, 30, 0, 0, chicago), false},
		{"Independence Day 2026 (Jul 4) — falls SATURDAY, closed by the weekly rule", time.Date(2026, 7, 4, 10, 0, 0, 0, chicago), false},
		{"Independence Day observed 2026 (Jul 3 Fri) — SHORTENED, before close", time.Date(2026, 7, 3, 10, 0, 0, 0, chicago), true},
		...
		{"Day after Thanksgiving 2026 (Nov 27) — SHORTENED, before close", time.Date(2026, 11, 27, 10, 0, 0, 0, chicago), true},
		{"Day after Thanksgiving 2026 — after its 12:00 CT close", time.Date(2026, 11, 27, 12, 30, 0, 0, chicago), false},
		{"Christmas Eve 2026 — SHORTENED, before close", time.Date(2026, 12, 24, 10, 0, 0, 0, chicago), true},
		{"Christmas Eve 2026 — after its 12:00 CT close", time.Date(2026, 12, 24, 12, 30, 0, 0, chicago), false},
