...
func TestRunPlannedAgentReturnsTimeoutMessageOnPlannerTimeout(t *testing.T) {
	t.Skip("TODO: adapt to fork's agent API — see PR #3 merge 2026-05-25, incoming test from main targets upstream API (hangs the test package; was masking the 16-test FAIL list)")
