...
export function PageNotFound() {
    return (
        <DeepVoidBackground className="flex items-center justify-center text-center p-4">
            <div className="bg-vl-bg border border-vl-gold/20 p-8 rounded-lg max-w-md w-full relative overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col items-center gap-6">
                    <div className="relative">
                        ...
                        <AlertCircle size={64} className="text-vl-danger relative z-10" />
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="text-xs uppercase tracking-[0.3em] text-vl-danger font-mono border-b border-vl-danger/30 pb-2 inline-block">
                            SIGNAL_LOST
                        </div>
                    </div>

                    <p className="text-sm text-vl-text-muted font-mono leading-relaxed">
                    ...
                    <a
                        href="/"
                        className="flex items-center gap-2 px-6 py-3 bg-vl-gold text-black font-bold text-sm uppercase tracking-widest rounded hover:bg-yellow-400 transition-all shadow-neon hover:shadow-[0_0_20px_rgba(240,185,11,0.4)] group mt-4"
                    >
                        <Home size={16} />
