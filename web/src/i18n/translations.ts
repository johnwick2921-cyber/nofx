...
export const translations = {
  en: {
    ...
    strategyStudio: {
      ...
      promptVariant: 'Style',
      balanced: 'Balanced',
      variantFutures: 'Futures (NQ/MNQ)',
      gridTradingFuturesUnsupported:
        'Grid trading is crypto-only; CME futures use AI Trading',
  ...
  zh: {
    ...
    strategyStudio: {
      ...
      promptVariant: '风格',
      balanced: '平衡',
      variantFutures: '期货 (NQ/MNQ)',
      gridTradingFuturesUnsupported:
        '网格交易仅限加密货币；CME 期货使用 AI 交易',
      aggressive: '激进',
      conservative: '保守',
  ...
  id: {
    ...
    strategyStudio: {
      ...
      variantFutures: 'Futures (NQ/MNQ)',
      gridTradingFuturesUnsupported:
        'Grid trading hanya untuk kripto; futures CME memakai AI Trading',
      aggressive: 'Agresif',
