...
export const translations = {
  en: {
    ...
    customModelNamePlaceholder: 'e.g.: deepseek-v4-pro, qwen3-max, gpt-4o',
    ...
    forgotAccountConfirm:
      'This will clear all account data and allow you to register a new account. Continue?',
    ...
    strategyStudio: {
      ...
      marketCrypto: 'Crypto',
      marketLockedHint: 'Auto-set from the strategy symbol (read-only)',
      selectModel: 'Select AI Model',
      runTest: 'Run AI Test',
      running: 'Running...',
      aiOutput: 'AI Output',
      ...
      deleteBlockedByBinding:
        'Active strategy cannot be deleted — bound to trader {names}',
      tradingBoundTo: 'trading: bound to trader {names}',
      tradingNoBound: 'trading: no trader bound',
  ...
  zh: {
    ...
    customModelNamePlaceholder: '例如: deepseek-v4-pro, qwen3-max, gpt-4o',
    saveConfig: '保存配置',
    editExchange: '编辑交易所',
    addExchange: '添加交易所',
    ...
    strategyStudio: {
      ...
      deleteBlockedByBinding: '激活中的策略不能删除 — 已绑定交易员 {names}',
      tradingBoundTo: '交易中：已绑定交易员 {names}',
      tradingNoBound: '交易中：未绑定交易员',
      displayActive: '显示：激活',
      displayInactive: '显示：未激活',
  ...
  id: {
    ...
    customModelNamePlaceholder: 'misal: deepseek-v4-pro, qwen3-max, gpt-4o',
    ...
    forgotAccountConfirm:
      'Ini akan menghapus semua data akun dan memungkinkan Anda mendaftar akun baru. Lanjutkan?',
    forgotAccountSuccess:
    ...
    strategyStudio: {
      ...
      futures: 'Berjangka',
      market: 'Pasar',
      marketFutures: 'Berjangka',
      marketCrypto: 'Kripto',
      marketLockedHint: 'Otomatis dari simbol strategi (hanya-baca)',
      selectModel: 'Pilih Model AI',
      ...
      deleteBlockedByBinding:
        'Strategi aktif tidak bisa dihapus — terikat ke trader {names}',
      tradingBoundTo: 'trading: terikat ke trader {names}',
      tradingNoBound: 'trading: tidak ada trader terikat',
      displayActive: 'tampilan: aktif',
      displayInactive: 'tampilan: nonaktif',
