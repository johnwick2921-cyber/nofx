        ...
        <div className="mb-8 text-center">
          <div className="flex justify-center mb-6">
            <div className="relative">
              <div className="absolute -inset-2 bg-vl-gold/20 rounded-full blur-xl animate-pulse"></div>
              <img
                src="/icons/vl.svg"
                alt="VL"
          ...
          <h1 className="text-3xl font-bold tracking-tighter text-white uppercase mb-2">
            <span className="text-vl-gold">NEW_USER</span> ONBOARDING
          </h1>
            ...
            <form onSubmit={handleRegister} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black/50 border border-zinc-700 rounded px-4 py-3 text-sm focus:border-vl-gold focus:ring-1 focus:ring-vl-gold/50 outline-none transition-all placeholder-zinc-800 text-white font-mono"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-black/50 border border-zinc-700 rounded px-4 py-3 text-sm focus:border-vl-gold focus:ring-1 focus:ring-vl-gold/50 outline-none transition-all placeholder-zinc-800 text-white font-mono pr-10"
                      placeholder="••••••••"
                      required
                    />
                    <button
              ...
              {betaMode && (
                <div>
                  <label className="block text-xs uppercase tracking-wider text-vl-gold mb-1.5 ml-1 font-bold">
                  ...
                  <input
                    ...
                    className="w-full bg-black/50 border border-zinc-700 rounded px-4 py-3 text-sm focus:border-vl-gold focus:ring-1 focus:ring-vl-gold/50 outline-none transition-all placeholder-zinc-800 text-white font-mono tracking-widest"
                    placeholder="XXXXXX"
                    maxLength={6}
                    required={betaMode}
                  />
              ...
              <button
                ...
                className="w-full bg-vl-gold text-black font-bold py-3 px-4 rounded text-sm tracking-wide uppercase hover:bg-yellow-400 transition-all transform active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed font-mono shadow-[0_0_15px_rgba(255,215,0,0.1)] hover:shadow-[0_0_25px_rgba(255,215,0,0.25)] flex items-center justify-center gap-2 group mt-4"
              >
                {loading ? (
        ...
        <div className="text-center mt-8 space-y-4">
          <p className="text-xs font-mono text-zinc-500">
            ...
            <button
              ...
              className="text-vl-gold hover:underline hover:text-yellow-300 transition-colors ml-1 uppercase"
            >
              ACCESS TERMINAL
            </button>
          </p>
