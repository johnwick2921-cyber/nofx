      ...
      >
        ...
        >
          ...
          >
            ...
            {/* FIX-KNOBS P2-3 (2026-09-26) — the shipped-default-ON knobs with
                no editing surface: READ-ONLY rows showing the server's
                effective value + origin (a raw JSON edit is the only way to
                change them — that surface is deliberate). */}
            <div
              className="mt-1 pt-2"
              style={{ borderTop: '1px solid var(--vl-hair)' }}
            >
              <span
                ...
                style={{ color: 'var(--vl-faint)' }}
              >
                {tp('shippedDefaults', language)}
              </span>
              <FieldRow
                label={tp('zonePlaceWithinPts', language)}
                knob={dpEff('zone_place_within_pts')}
              >
                <span
              ...
              <FieldRow
                label={tp('plannerContract', language)}
                knob={dpEff('planner_contract')}
              >
                <span
                  className="text-[10px] uppercase"
                  style={{ color: 'var(--vl-faint)' }}
              ...
              <FieldRow
                label={tp('plannerFreshTape', language)}
                knob={dpEff('planner_fresh_tape')}
              >
                <span
                  className="text-[10px] uppercase"
                  style={{ color: 'var(--vl-faint)' }}
              ...
              <FieldRow
                label={tp('writeTimeFeasibility', language)}
                knob={dpEff('write_time_feasibility')}
              >
                <span
                  className="text-[10px] uppercase"
                  style={{ color: 'var(--vl-faint)' }}
              ...
              <FieldRow
                label={tp('geometryRefLevels', language)}
                knob={dpEff('geometry_reference_levels')}
              >
                <span
                  className="text-[10px] uppercase"
                  style={{ color: 'var(--vl-faint)' }}
              ...
              <FieldRow
                label={tp('conditionStatus', language)}
                knob={dpEff('condition_status')}
              >
                <span
                  className="text-[10px] uppercase"
                  style={{ color: 'var(--vl-faint)' }}
              ...
              <FieldRow
                label={tp('fadeOrWideK', language)}
                knob={dpEff('fade_or_wide_k')}
              >
                <span
                  className="text-[10px] uppercase"
                  style={{ color: 'var(--vl-faint)' }}
              ...
              >
                ...
                {isOpen && (
                  <div className="px-2.5 pb-2 flex flex-col gap-1">
                    ...
                    {/* FIX-KNOBS P2-3 (2026-09-26) — the two per-session
                        offsets are resolved (override → shipped default) but
                        have no editing surface: READ-ONLY rows. */}
                    <FieldRow
                      label={tp('lastEntryOffsetMin', language)}
                      knob={sessEff(s, 'last_entry_offset_min')}
                    >
                      <span
                        className="text-[10px] uppercase"
                        style={{ color: 'var(--vl-faint)' }}
                    ...
                    <FieldRow
                      label={tp('eodFlatOffsetMin', language)}
                      knob={sessEff(s, 'eod_flat_offset_min')}
                    >
                      <span
                        className="text-[10px] uppercase"
                        style={{ color: 'var(--vl-faint)' }}
