...
export function TokenEstimateBar({ config, language, onTokenCountChange }: TokenEstimateBarProps) {
  ...
  if (isLoading && !estimate) {
    return (
      <div className="flex items-center gap-1.5 text-xs text-vl-text-muted">
    ...
    <div className="space-y-1">
      <div className="flex items-center gap-2">
        ...
        <div className="relative group">
          <Info className="w-3 h-3 text-vl-text-muted cursor-help" />
          <div className="absolute bottom-full right-0 mb-1.5 px-2.5 py-1.5 rounded-lg text-[10px] whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 bg-vl-bg-lighter border border-vl-border text-vl-text-muted shadow-lg">
