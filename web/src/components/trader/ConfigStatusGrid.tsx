          ...
          {configuredModels.map((model) => {
            ...
            return (
              <div
                ...
                title={
                  inUse
                    ? 'In use by a running trader — click to view/edit the key (delete is blocked until you switch that trader).'
                    : undefined
                }
                className={`group relative flex items-center justify-between p-3 rounded-md transition-all border border-transparent cursor-pointer hover:bg-white/5 hover:border-white/10 ${
                  inUse ? 'opacity-90' : ''
                } bg-black/20`}
