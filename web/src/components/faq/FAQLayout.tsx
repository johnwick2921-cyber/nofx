      ...
      <div className="w-full px-4 md:px-8">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            <div className="w-16 h-16 rounded-full flex items-center justify-center bg-gradient-to-br from-vl-gold to-[#FCD535] shadow-[0_8px_24px_rgba(240,185,11,0.4)]">
              <HelpCircle className="w-8 h-8 text-[#0B0E11]" />
            </div>
          </div>
          <h1 className="text-4xl font-bold mb-4 text-vl-text-main">
            {t('faqTitle', language)}
          </h1>
          <p className="text-lg mb-8 text-vl-text-muted">
