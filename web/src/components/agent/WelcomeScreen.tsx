      ...
      : [
          {
            icon: <BarChart3 size={18} />,
            title: 'Analyze MNQ',
            subtitle: 'Technical analysis + sentiment',
            cmd: 'Analyze MNQ price action',
          },
          {
            icon: <Zap size={18} />,
            title: 'Trade MNQ',
            subtitle: 'Agent executes for you',
            cmd: 'Open a long position on MNQ 1 contract',
          },
          {
            icon: <Search size={18} />,
            title: 'Search Futures',
            subtitle: 'Enter symbol or contract',
            cmd: 'Search for NQ futures contract',
          },
          {
            icon: <Lightbulb size={18} />,
            title: 'Strategy Ideas',
            subtitle: 'Market-based suggestions',
            cmd: 'What strategy fits the current market?',
          },
        ]
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {language === 'zh' ? '跟 VL 聊点什么' : 'What can I help with?'}
        </h1>
        <p
          style={{
            fontSize: 13.5,
