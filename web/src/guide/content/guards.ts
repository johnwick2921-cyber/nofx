...
export const guards: GuideSection = {
  ...
  blocks: [
    ...
    { kind: 'p', text: 'When current one-setup permission is unavailable, an older unplaced authorization cannot substitute for it. That authorization is retired; if retirement cannot be saved, the cycle submits no new entry.' },
