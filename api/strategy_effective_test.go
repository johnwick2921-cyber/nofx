...
const effectiveResolvedPin = 85 // PLANNER A6 2026-09-25: +1 (planner_fresh_tape); W-EXEC-TRUTH W3: +4 (entry_policy_default, zone_max_pts, zone_rest_max_min, min_hold_min)
