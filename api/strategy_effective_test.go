...
const effectiveResolvedPin = 88 // FIX-PLANNER 2026-09-26: +1 (death_reread_retry_min); PLANNER A6 2026-09-25: +1 (planner_fresh_tape); PLANNER B1 2026-09-25: +1 (zone_place_within_pts); W-EXEC-TRUTH W3: +4 (entry_policy_default, zone_max_pts, zone_rest_max_min, min_hold_min); FIX-KNOBS 2026-09-26: +1 (planner_contract resolver — kept as real wiring, feeds the boot-line truth)
