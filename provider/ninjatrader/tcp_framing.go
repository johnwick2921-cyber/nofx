...
type FillPayload struct {
	OrderedHandled bool   `json:"-"`                // W117 F2 — the owning ordered consumer already ran
...
type OrderUpdatePayload struct {
	OrderedArrival bool    `json:"-"`                // W117 F2 — consumed on the read goroutine, in receive order
	OrderedHandled bool    `json:"-"`                // W117 F2 — the owning ordered consumer already ran
