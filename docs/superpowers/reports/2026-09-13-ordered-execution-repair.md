...
Root's subsequent audit found two additional boundaries under repair: positive-filled rejected entry Fill must not clear actual exposure, and a position snapshot received before a positive entry must not overwrite that later evidence with flat. The final verification ledger must identify their follow-up commit and tests before removing this pending qualification.
