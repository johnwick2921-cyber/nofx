...
- **Research-snapshot recorder knobs (dispatch 103, 2026-09-16):** `RESEARCH_SNAPSHOT` (unset/0 = OFF; boot line "research snapshot: OFF (RESEARCH_SNAPSHOT unset)") · `RESEARCH_LOG_EVERY_S` (default 60 — rollup cadence; rows-per-object + drops + queue depth) · `RESEARCH_RETAIN_DAYS` (default 7 — boot + daily prune of `research_facts`, no auto-VACUUM) · drop notices WARN-coalesced 1/min — researchsnapshot/runtime.go, researchsnapshot/volume.go.
