...
[^20]: Dalton, James F., Eric T. Jones, and Robert B. Dalton (1990; updated 2013). *Mind Over Markets: Power Trading with Market Generated Information*. **Wiley**, practitioner book; [author's books page](https://jimdaltontrading.com/books/). Market-profile/auction interpretation across futures examples; no reproducible instrument-period sample or tested classifier n. **TRANSFERS:** practitioner vocabulary and process only. Acceptance/rejection and ongoing auction interpretation are doctrine here, not an established NQ dwell threshold or automatic trading rule.
